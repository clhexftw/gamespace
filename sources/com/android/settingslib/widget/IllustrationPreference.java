...
public class IllustrationPreference extends Preference {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
            ...
            this.mCacheComposition = obtainStyledAttributes.getBoolean(R$styleable.LottieAnimationView_lottie_cacheComposition, true);
            TypedArray obtainStyledAttributes2 = context.obtainStyledAttributes(attributeSet, R$styleable.IllustrationPreference, 0, 0);
            this.mLottieDynamicColor = obtainStyledAttributes2.getBoolean(R$styleable.IllustrationPreference_dynamicColor, false);
