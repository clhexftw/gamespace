...
public class MiscScenesVibrationPreferenceController extends CustomVibrationTogglePreferenceController {
    ...
    public MiscScenesVibrationPreferenceController(Context context, String str) {
        super(context, str, new CustomVibrationPreferenceConfig(context, "haptic_feedback_enabled", "custom_haptic_on_misc_scenes"));
    }
