...
public class RingtoneVibrationPatternPreferenceController extends VibrationPatternPreferenceController {
    ...
    public RingtoneVibrationPatternPreferenceController(Context context, String str) {
        super(context, str);
    }

    @Override // com.android.settings.accessibility.VibrationPatternPreferenceController
    public VibrationAttributes getAttribute() {
        return CustomVibrationAttributes.VIBRATION_ATTRIBUTES_PREVIEW_ALARM_CALL;
    }
}
