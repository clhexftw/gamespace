...
public final class AccessibilityGestureNavigationTutorial {
    ...
    private static void setupGestureNavigationTextWithImage(Context context, View view) {
        ...
        if (isTouchExploreEnabled) {
            i = R.drawable.a11y_gesture_navigation_three_finger_preview;
        } else {
            i = R.drawable.a11y_gesture_navigation_two_finger_preview;
        }
    ...
    private static TutorialPage createHardwareTutorialPage(Context context) {
        ...
        View createIllustrationView = createIllustrationView(context, R.drawable.a11y_shortcut_type_hardware);
        ImageView createImageView = createImageView(context, R.drawable.ic_accessibility_page_indicator);
    ...
    private static TutorialPage createTripleTapTutorialPage(Context context) {
        ...
        View createIllustrationViewWithImageRawResource = createIllustrationViewWithImageRawResource(context, R.raw.a11y_shortcut_type_triple_tap);
    ...
    private static View createSoftwareImage(Context context) {
        ...
        if (AccessibilityUtil.isFloatingMenuEnabled(context)) {
            i = R.drawable.a11y_shortcut_type_software_floating;
        } else if (AccessibilityUtil.isGestureNavigateEnabled(context)) {
            if (AccessibilityUtil.isTouchExploreEnabled(context)) {
                i = R.drawable.a11y_shortcut_type_software_gesture_talkback;
            } else {
                i = R.drawable.a11y_shortcut_type_software_gesture;
            }
        } else {
            i = R.drawable.a11y_shortcut_type_software;
        }
    ...
    public static class TutorialPageChangeListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageSelected(int i) {
            ...
            int i2 = z ? 17432578 : 17432747;
            int i3 = z ? 17432579 : 17432750;
