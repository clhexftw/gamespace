...
public class AccessibilityLayerDrawable extends LayerDrawable {
    ...
    public static AccessibilityLayerDrawable createLayerDrawable(Context context, int i, int i2) {
        AccessibilityLayerDrawable accessibilityLayerDrawable = new AccessibilityLayerDrawable(new Drawable[]{context.getDrawable(R.drawable.a11y_button_preview_base), null});
