...
public class VibrateOnConnectedTogglePreferenceController extends CustomVibrationTogglePreferenceController {
    ...
    public VibrateOnConnectedTogglePreferenceController(Context context, String str) {
        super(context, str, new CustomVibrationPreferenceConfig(context, "vibrate_on", "vibrate_on_connect"));
    }
}
