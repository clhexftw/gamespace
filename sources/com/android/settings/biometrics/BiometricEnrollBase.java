...
public abstract class BiometricEnrollBase extends InstrumentedActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.mPostureGuidanceIntent = FeatureFactory.getFactory(getApplicationContext()).getFaceFeatureProvider().getPostureGuidanceIntent(getApplicationContext());
    }
    ...
    public void onStop() {
        ...
        if (screenSizeFoldProvider != null && (foldProvider$FoldCallback = this.mFoldCallback) != null) {
            screenSizeFoldProvider.unregisterCallback(foldProvider$FoldCallback);
        }
