    ...
    protected List<AbstractPreferenceController> createPreferenceControllers(Context context) {
        if (isFaceHardwareDetected(context)) {
            ...
            for (AbstractPreferenceController abstractPreferenceController : buildPreferenceControllers) {
                ...
                } else if (abstractPreferenceController instanceof FaceSettingsRedoPreferenceController) {
                    FaceSettingsRedoPreferenceController faceSettingsRedoPreferenceController = (FaceSettingsRedoPreferenceController) abstractPreferenceController;
