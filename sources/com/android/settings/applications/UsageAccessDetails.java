        ...
        if (preference == this.mSwitchPref) {
            if (this.mUsageState != null && ((Boolean) obj).booleanValue() != this.mUsageState.isPermissible()) {
                if (this.mUsageState.isPermissible() && this.mDpm.isProfileOwnerApp(this.mPackageName)) {
                    new AlertDialog.Builder(getContext()).setIcon(17302413).setTitle(17039380).setMessage(this.mDpm.getResources().getString("Settings.WORK_PROFILE_DISABLE_USAGE_ACCESS_WARNING", new Supplier() { // from class: com.android.settings.applications.UsageAccessDetails$$ExternalSyntheticLambda0
