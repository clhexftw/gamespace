...
public class WifiDppQrCodeGeneratorFragment extends WifiDppQrCodeBaseFragment {
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        final String preSharedKey = wifiNetworkConfigFromHostActivity.getPreSharedKey();
        ...
        if (TextUtils.isEmpty(preSharedKey)) {
            ...
            textView.setOnClickListener(new View.OnClickListener() { // from class: com.android.settings.wifi.dpp.WifiDppQrCodeGeneratorFragment$$ExternalSyntheticLambda0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    WifiDppQrCodeGeneratorFragment.this.lambda$onViewCreated$0(view2);
                }
            });
            textView.setOnLongClickListener(new View.OnLongClickListener() { // from class: com.android.settings.wifi.dpp.WifiDppQrCodeGeneratorFragment$$ExternalSyntheticLambda1
                @Override // android.view.View.OnLongClickListener
                public final boolean onLongClick(View view2) {
                    boolean lambda$onViewCreated$1;
                    lambda$onViewCreated$1 = WifiDppQrCodeGeneratorFragment.this.lambda$onViewCreated$1(preSharedKey, view2);
                    return lambda$onViewCreated$1;
                }
            });
        }
        final Intent component = new Intent().setComponent(getNearbySharingComponent());
        addActionButton((ViewGroup) view.findViewById(R.id.wifi_dpp_layout), createNearbyButton(component, new View.OnClickListener() { // from class: com.android.settings.wifi.dpp.WifiDppQrCodeGeneratorFragment$$ExternalSyntheticLambda2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                WifiDppQrCodeGeneratorFragment.this.lambda$onViewCreated$2(component, wifiNetworkConfigFromHostActivity, view2);
            }
        }));
    ...
    public /* synthetic */ void lambda$onViewCreated$0(View view) {
        Toast.makeText(getContext(), R.string.longpress_to_clipboard, 0).show();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ boolean lambda$onViewCreated$1(String str, View view) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onViewCreated$2(Intent intent, WifiNetworkConfig wifiNetworkConfig, View view) {
    ...
    private void addActionButton(ViewGroup viewGroup, Button button) {
        ...
        int dimensionPixelSize = getResources().getDimensionPixelSize(17105515) / 2;
