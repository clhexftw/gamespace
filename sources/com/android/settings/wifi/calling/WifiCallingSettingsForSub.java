    ...
    private class PhoneTelephonyCallback extends TelephonyCallback implements TelephonyCallback.CallStateListener {
        ...
        public void onCallStateChanged(int i) {
            ...
            if (settingsMainSwitchPreference != null) {
                ...
                z2 = wifiCallingSettingsForSub.getTelephonyManagerForSub(wifiCallingSettingsForSub.mSubId).getCallState() == 0;
                if (isChecked || z2) {
                    WifiCallingSettingsForSub wifiCallingSettingsForSub2 = WifiCallingSettingsForSub.this;
                    isAllowUserControl = wifiCallingSettingsForSub2.queryImsState(wifiCallingSettingsForSub2.mSubId).isAllowUserControl();
                } else {
                    isAllowUserControl = true;
                }
