    ...
    */
    ...
    public void showSecurityFields(boolean z, boolean z2) {
        ...
        if (z) {
            ...
            } else if (Utils.isWifiOnly(this.mContext) || !this.mContext.getResources().getBoolean(17891627)) {
    ...
    void loadSims() {
        ...
        for (SubscriptionInfo subscriptionInfo3 : this.mActiveSubscriptionInfos) {
            if (!arrayMap.containsKey(Integer.valueOf(subscriptionInfo3.getCarrierId())) || defaultDataSubscriptionId == subscriptionInfo3.getSubscriptionId()) {
                arrayMap.put(Integer.valueOf(subscriptionInfo3.getCarrierId()), SubscriptionUtil.getUniqueSubscriptionDisplayName(subscriptionInfo3, this.mContext));
            }
        }
        this.mEapSimSpinner.setAdapter((SpinnerAdapter) getSpinnerAdapter((String[]) arrayMap.values().toArray(new String[arrayMap.size()])));
        this.mEapSimSpinner.setSelection(0);
        if (arrayMap.size() == 1) {
            this.mEapSimSpinner.setEnabled(false);
        }
