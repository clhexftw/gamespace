...
public class AccountDashboardFragment extends DashboardFragment {
    ...
    public static void buildAccountPreferenceControllers(Context context, DashboardFragment dashboardFragment, String[] strArr, List<AbstractPreferenceController> list) {
        AccountPreferenceController accountPreferenceController = new AccountPreferenceController(context, dashboardFragment, strArr, 3);
