...
public class WallpaperPreferenceController extends BasePreferenceController {
    ...
    public WallpaperPreferenceController(Context context, String str) {
        ...
        this.mWallpaperActionName = this.mContext.getString(R.string.config_wallpaper_picker_action);
        this.mStylesAndWallpaperActionName = this.mContext.getString(R.string.config_styles_and_wallpaper_picker_action);
    ...
    public String getComponentActionName() {
        return areStylesAvailable() ? this.mStylesAndWallpaperActionName : this.mWallpaperActionName;
    }
