...
public class NetworkTrafficPreferenceController extends TogglePreferenceController implements LifecycleObserver, OnStart, OnStop {
    ...
    public NetworkTrafficPreferenceController(Context context, String str) {
        super(context, str);
    }
    ...
    private class SettingObserver extends ContentObserver {
        ...
        SettingObserver(Preference preference) {
            super(new Handler());
            this.mUri = Settings.System.getUriFor(NetworkTrafficPreferenceController.KEY);
        ...
        public void onChange(boolean z, Uri uri) {
            ...
            if (uri == null || this.mUri.equals(uri)) {
                NetworkTrafficPreferenceController.this.updateState(this.mPreference);
            }
        }
    }
}
