...
public class MinRefreshRatePreferenceController extends BasePreferenceController implements Preference.OnPreferenceChangeListener {
    ...
    public MinRefreshRatePreferenceController(Context context, String str) {
        super(context, str);
    ...
    public void updateState(Preference preference) {
        String valueOf = String.valueOf(this.mHelper.getMinimumRefreshRate());
        ...
        if (this.mHelper.getPeakRefreshRate() < parseInt) {
            this.mHelper.setPeakRefreshRate(parseInt);
        }
    ...
    public boolean onPreferenceChange(Preference preference, Object obj) {
        this.mHelper.setMinimumRefreshRate(Integer.parseInt((String) obj));
