...
public class ColorModePreferenceFragment extends RadioButtonPickerFragment {
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(R.xml.color_mode_settings) { // from class: com.android.settings.display.ColorModePreferenceFragment.3
        ...
        public boolean isPageSearchEnabled(Context context) {
            ...
            return ColorModePreferenceFragment.hasCustomColorMode(intArray) || !(intArray == null || intArray.length <= 0 || ColorDisplayManager.areAccessibilityTransformsEnabled(context));
        }
    };
    ...
    public void updateCandidates() {
        ...
        getPreferenceManager().inflateFromResource(preferenceScreen.getContext(), R.xml.color_mode_settings, preferenceScreen);
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static boolean hasCustomColorMode(int[] iArr) {
        if (iArr == null) {
            return false;
        }
        for (int i : iArr) {
