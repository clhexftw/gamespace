...
public class DcDimmingPreferenceController extends TogglePreferenceController implements LifecycleObserver, OnStart, OnStop {
    private static final String KEY = "dc_dimming_state";
    ...
    public DcDimmingPreferenceController(Context context, String str) {
        super(context, str);
    ...
    public int getAvailabilityStatus() {
        return this.mManager.hasFeature(1) ? 0 : 3;
    }
    ...
    public boolean setChecked(boolean z) {
        return Settings.System.putIntForUser(this.mContext.getContentResolver(), KEY, z ? 1 : 0, 0);
    }
    ...
    private class SettingObserver extends ContentObserver {
        ...
        SettingObserver(Preference preference) {
            super(new Handler());
            this.mUri = Settings.System.getUriFor(DcDimmingPreferenceController.KEY);
        ...
        public void onChange(boolean z, Uri uri) {
            ...
            if (uri == null || this.mUri.equals(uri)) {
                DcDimmingPreferenceController.this.updateState(this.mPreference);
            }
        }
    }
}
