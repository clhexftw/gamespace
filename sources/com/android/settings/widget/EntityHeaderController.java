...
public class EntityHeaderController {
    ...
    public EntityHeaderController setIcon(ApplicationsState.AppEntry appEntry) {
        ...
        this.mPackageNameReal = appEntry.info.packageName;
        return this;
    }
    ...
    public View done(Activity activity, boolean z) {
        ...
        if (imageView != null) {
            ...
            if (this.mPackageNameReal != null) {
                imageView.setOnClickListener(new View.OnClickListener() { // from class: com.android.settings.widget.EntityHeaderController.1
                    @Override // android.view.View.OnClickListener
                    public void onClick(View view) {
                        Intent launchIntentForPackage = view.getContext().getPackageManager().getLaunchIntentForPackage(EntityHeaderController.this.mPackageNameReal);
    ...
    private void bindAppInfoLink(View view) {
        ...
        if (this.mHasAppInfoLink) {
            if (view == null || (str = this.mPackageName) == null || str.equals("os") || this.mUid == -10000) {
                ...
                view.setOnClickListener(new View.OnClickListener() { // from class: com.android.settings.widget.EntityHeaderController.2
                    @Override // android.view.View.OnClickListener
    ...
    private void bindButton(ImageButton imageButton, int i) {
        ...
        if (i == 0) {
            ...
            imageButton.setImageResource(17302781);
            imageButton.setVisibility(0);
