...
public class GesturesSettingPreferenceController extends BasePreferenceController {
    ...
    private static List<AbstractPreferenceController> buildAllPreferenceControllers(Context context) {
        ...
        arrayList.add(new SwipeToScreenshotPreferenceController(context, FAKE_PREF_KEY));
        arrayList.add(new VolumeButtonMusicControlPreferenceController(context, FAKE_PREF_KEY));
        return arrayList;
    }
}
