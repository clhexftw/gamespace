...
public class SystemNavigationPreferenceController extends BasePreferenceController {
    ...
    public static boolean isGestureAvailable(Context context) {
        ...
        if (context.getResources().getBoolean(17891826) && (unflattenFromString = ComponentName.unflattenFromString(LauncherUtils.getComponentName(context))) != null) {
    ...
    public static boolean is2ButtonNavigationEnabled(Context context) {
        return 1 == context.getResources().getInteger(17694898);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static boolean isGestureNavigationEnabled(Context context) {
        return 2 == context.getResources().getInteger(17694898);
    }
}
