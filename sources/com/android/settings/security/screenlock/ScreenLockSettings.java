...
public class ScreenLockSettings extends DashboardFragment implements OwnerInfoPreferenceController.OwnerInfoCallback {
    ...
    public static List<AbstractPreferenceController> buildPreferenceControllers(Context context, DashboardFragment dashboardFragment, LockPatternUtils lockPatternUtils) {
        ...
        arrayList.add(new PinPrivacyPreferenceController(context, i, lockPatternUtils));
        arrayList.add(new PatternErrorVisiblePreferenceController(context, i, lockPatternUtils));
        arrayList.add(new PatternDotsVisiblePreferenceController(context, i, lockPatternUtils));
        ...
        arrayList.add(new ScramblePinPreferenceController(context, i, lockPatternUtils));
        return arrayList;
    }
}
