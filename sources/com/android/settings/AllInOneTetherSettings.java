...
public class AllInOneTetherSettings extends RestrictedDashboardFragment implements DataSaverBackend.Listener, WifiTetherBasePreferenceController.OnTetherConfigUpdateListener {
    ...
    static final String KEY_WIFI_TETHER_HIDDEN_SSID = "wifi_tether_hidden_ssid_2";
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider(R.xml.all_tether_prefs) { // from class: com.android.settings.AllInOneTetherSettings.3
        ...
        public List<String> getNonIndexableKeys(Context context) {
            ...
            if (!TetherUtil.isTetherAvailable(context)) {
                ...
                nonIndexableKeys.add("wifi_tether_client_manager_2");
            }
    ...
    public void onAttach(Context context) {
        ...
        this.mAutoOffPreferenceController = (WifiTetherAutoOffPreferenceController) use(WifiTetherAutoOffPreferenceController.class);
        this.mClientPreferenceController = (WifiTetherClientManagerPreferenceController) use(WifiTetherClientManagerPreferenceController.class);
    ...
    private SoftApConfiguration buildNewConfig() {
        ...
        this.mAutoOffPreferenceController.updateConfig(builder);
        this.mClientPreferenceController.updateConfig(builder);
        builder.setHiddenSsid(this.mHiddenSsidPreferenceController.isHiddenSsidEnabled());
    ...
    public void updateDisplayWithNewConfig() {
        ...
        this.mAutoOffPreferenceController.updateDisplay();
    }
