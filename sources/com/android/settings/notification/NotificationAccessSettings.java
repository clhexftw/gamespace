...
public class NotificationAccessSettings extends EmptyTextSettings {
    ...
    public void onCreate(Bundle bundle) {
        ...
        ServiceListing build = builder.setPermission(config.permission).setIntentAction(config.intentAction).setNoun(config.noun).setSetting(config.setting).setTag(config.tag).setValidator(new Predicate() { // from class: com.android.settings.notification.NotificationAccessSettings$$ExternalSyntheticLambda0
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean lambda$onCreate$0;
                lambda$onCreate$0 = NotificationAccessSettings.lambda$onCreate$0((ServiceInfo) obj);
        ...
        if (UserManager.get(this.mContext).isManagedProfile()) {
            Toast.makeText(this.mContext, this.mDpm.getResources().getString("Settings.WORK_APPS_CANNOT_ACCESS_NOTIFICATION_SETTINGS", new Supplier() { // from class: com.android.settings.notification.NotificationAccessSettings$$ExternalSyntheticLambda2
                @Override // java.util.function.Supplier
                public final Object get() {
                    String lambda$onCreate$1;
                    lambda$onCreate$1 = NotificationAccessSettings.this.lambda$onCreate$1();
    ...
    public static /* synthetic */ boolean lambda$onCreate$0(ServiceInfo serviceInfo) {
        return serviceInfo.getComponentName().flattenToString().length() <= 500;
    }
    ...
    public void updateList(List<ServiceInfo> list) {
        ...
        for (final ServiceInfo serviceInfo : list) {
            ...
            if (managedProfileId != -10000 && !this.mDpm.isNotificationListenerServicePermitted(serviceInfo.packageName, managedProfileId)) {
                appPreference.setSummary(this.mDpm.getResources().getString("Settings.WORK_PROFILE_NOTIFICATION_LISTENER_BLOCKED", new Supplier() { // from class: com.android.settings.notification.NotificationAccessSettings$$ExternalSyntheticLambda3
                    @Override // java.util.function.Supplier
                    public final Object get() {
                        String lambda$updateList$2;
                        lambda$updateList$2 = NotificationAccessSettings.this.lambda$updateList$2();
                        return lambda$updateList$2;
                    }
                }));
            }
            appPreference.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() { // from class: com.android.settings.notification.NotificationAccessSettings$$ExternalSyntheticLambda4
                @Override // androidx.preference.Preference.OnPreferenceClickListener
                public final boolean onPreferenceClick(Preference preference) {
                    boolean lambda$updateList$3;
                    lambda$updateList$3 = NotificationAccessSettings.this.lambda$updateList$3(componentName, serviceInfo, preference);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ String lambda$updateList$2() {
        return getString(R.string.work_profile_notification_access_blocked_summary);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ boolean lambda$updateList$3(ComponentName componentName, ServiceInfo serviceInfo, Preference preference) {
