...
public class NetworkOperatorPreference extends Preference {
    ...
    private NetworkOperatorPreference(Context context, List<String> list, boolean z) {
        ...
        this.mUseNewApi = context.getResources().getBoolean(17891647);
    }
    ...
    private void updateIcon(int i) {
        ...
        setIcon(MobileNetworkUtils.getSignalStrengthIcon(getContext(), i, 5, getIconIdForCell(this.mCellInfo), false, false));
    }
}
