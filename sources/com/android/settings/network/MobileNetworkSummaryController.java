...
public class MobileNetworkSummaryController extends AbstractPreferenceController implements SubscriptionsChangeListener.SubscriptionsChangeListenerClient, LifecycleObserver, PreferenceControllerMixin {
    ...
    public CharSequence getSummary() {
        ...
        if (subscriptionList.isEmpty()) {
            ...
            return (CharSequence) subscriptionList.stream().mapToInt(new ToIntFunction() { // from class: com.android.settings.network.MobileNetworkSummaryController$$ExternalSyntheticLambda0
                @Override // java.util.function.ToIntFunction
                public final int applyAsInt(Object obj) {
                    return ((SubscriptionAnnotation) obj).getSubscriptionId();
                }
            }).mapToObj(new IntFunction() { // from class: com.android.settings.network.MobileNetworkSummaryController$$ExternalSyntheticLambda1
    ...
    private void update() {
        ...
        this.mStatusCache.update(this.mContext, new Consumer() { // from class: com.android.settings.network.MobileNetworkSummaryController$$ExternalSyntheticLambda2
        ...
        if (subscriptionList.isEmpty()) {
            if (this.mStatusCache.isEuiccConfigSupport()) {
                this.mPreference.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() { // from class: com.android.settings.network.MobileNetworkSummaryController$$ExternalSyntheticLambda3
        ...
        if (this.mStatusCache.isEuiccConfigSupport()) {
            this.mPreference.setAddWidgetEnabled(true);
            this.mPreference.setOnAddClickListener(new AddPreference.OnAddClickListener() { // from class: com.android.settings.network.MobileNetworkSummaryController$$ExternalSyntheticLambda4
    ...
    public boolean isAvailable() {
        return SubscriptionUtil.isSimHardwareVisible(this.mContext) && !Utils.isWifiOnly(this.mContext) && this.mUserManager.isAdminUser();
    }

    @Override // com.android.settings.network.SubscriptionsChangeListener.SubscriptionsChangeListenerClient
    public void onSubscriptionsChanged() {
        this.mStatusCache.update(this.mContext, new Consumer() { // from class: com.android.settings.network.MobileNetworkSummaryController$$ExternalSyntheticLambda6
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
                MobileNetworkSummaryController.this.lambda$onSubscriptionsChanged$5((MobileNetworkSummaryStatus) obj);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onSubscriptionsChanged$5(MobileNetworkSummaryStatus mobileNetworkSummaryStatus) {
        refreshSummary(this.mPreference);
        update();
    }
}
