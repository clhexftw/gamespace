...
public class TimeoutToDockUserSettings extends RadioButtonPickerFragment {
    ...
    public void onAttach(Context context) {
        ...
        this.mEntries = getContext().getResources().getStringArray(R.array.switch_to_dock_user_when_docked_timeout_entries);
        this.mValues = getContext().getResources().getStringArray(R.array.switch_to_dock_user_when_docked_timeout_values);
    }
    ...
    protected String getDefaultKey() {
        String stringForUser = Settings.Secure.getStringForUser(getContext().getContentResolver(), "timeout_to_dock_user", UserHandle.myUserId());
        return stringForUser != null ? stringForUser : this.mValues[1];
    }

    @Override // com.android.settings.widget.RadioButtonPickerFragment
    protected boolean setDefaultKey(String str) {
        Settings.Secure.putStringForUser(getContext().getContentResolver(), "timeout_to_dock_user", str, UserHandle.myUserId());
        return true;
    }
