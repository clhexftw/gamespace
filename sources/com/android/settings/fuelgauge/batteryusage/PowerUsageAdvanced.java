...
public class PowerUsageAdvanced extends PowerUsageBase {
    ...
    private final ContentObserver mBatteryObserver = new ContentObserver(new Handler()) { // from class: com.android.settings.fuelgauge.batteryusage.PowerUsageAdvanced.1
    ...
    protected void restartBatteryStatsLoader(int i) {
        ...
        if (z && !this.mIsChartDataLoaded) {
            ...
            restartLoader(3, bundle, this.mBatteryHistoryLoaderCallbacks);
        } else if (z) {
        } else {
