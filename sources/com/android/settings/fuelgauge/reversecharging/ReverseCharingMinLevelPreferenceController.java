...
public class ReverseCharingMinLevelPreferenceController extends BasePreferenceController {
    ...
    public ReverseCharingMinLevelPreferenceController(Context context, String str) {
        super(context, str);
    ...
    public final void updateState(Preference preference) {
        this.mPreference.setVisible(WirelessChargingSettingsHelper.getReverseChargingEnabled(this.mContext));
    }
}
