...
public class OptimizedChargeStatusPreferenceController extends BasePreferenceController {
    ...
    public OptimizedChargeStatusPreferenceController(Context context, String str) {
        super(context, str);
    ...
    public final void updateState(Preference preference) {
        ...
        this.mPreference.setValue(String.valueOf(OptimizedChargingSettingsHelper.getOptimizedChargingStatus(this.mContext)));
    }
}
