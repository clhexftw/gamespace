...
public class OptimizedChargeCeilingPreferenceController extends BasePreferenceController {
    ...
    public OptimizedChargeCeilingPreferenceController(Context context, String str) {
        super(context, str);
    ...
    public final void updateState(Preference preference) {
        ...
        this.mPreference.setValue(OptimizedChargingSettingsHelper.getOptimizedChargingCeiling(this.mContext));
    }
}
