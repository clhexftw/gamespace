...
public class QuietModeStatusPreferenceController extends BasePreferenceController {
    ...
    public QuietModeStatusPreferenceController(Context context, String str) {
        super(context, str);
    ...
    public final void updateState(Preference preference) {
        this.mPreference.setVisible(WirelessChargingSettingsHelper.getQuietModeEnabled(this.mContext));
        this.mPreference.setValue(String.valueOf(WirelessChargingSettingsHelper.getQuietModeStatus(this.mContext)));
    }
}
