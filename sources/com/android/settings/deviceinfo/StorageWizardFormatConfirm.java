...
public class StorageWizardFormatConfirm extends InstrumentedDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        if (z) {
            ...
            builder.setMessage(TextUtils.expandTemplate(getText(R.string.storage_wizard_format_confirm_v2_body_external), findDiskById.getDescription(), findDiskById.getShortDescription(), findDiskById.getShortDescription()));
        }
        builder.setNegativeButton(17039360, (DialogInterface.OnClickListener) null);
        builder.setPositiveButton(TextUtils.expandTemplate(getText(R.string.storage_menu_format_option), findDiskById.getShortDescription()), new DialogInterface.OnClickListener() { // from class: com.android.settings.deviceinfo.StorageWizardFormatConfirm$$ExternalSyntheticLambda0
