...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E exception) {
        ...
        if (exception instanceof CopyableThrowable) {
            try {
                ...
                m104constructorimpl = Result.m104constructorimpl(((CopyableThrowable) exception).createCopy());
            } catch (Throwable th) {
                Result.Companion companion2 = Result.Companion;
                m104constructorimpl = Result.m104constructorimpl(ResultKt.createFailure(th));
            }
            if (Result.m108isFailureimpl(m104constructorimpl)) {
                m104constructorimpl = null;
            }
            return (E) m104constructorimpl;
        }
                    ...
                    return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$createSafeConstructor$$inlined$safeCtor$1
                        ...
                        public final Throwable invoke(Throwable e) {
                            ...
                            try {
                                ...
                                m104constructorimpl = Result.m104constructorimpl((Throwable) newInstance);
                            } catch (Throwable th) {
                                Result.Companion companion2 = Result.Companion;
                                m104constructorimpl = Result.m104constructorimpl(ResultKt.createFailure(th));
                            }
                            ...
                            return (Throwable) m104constructorimpl;
                        }
                    };
                }
                return null;
                ...
                return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$createSafeConstructor$$inlined$safeCtor$3
                    ...
                    public final Throwable invoke(Throwable e) {
                        ...
                        try {
                            ...
                            th.initCause(e);
                            m104constructorimpl = Result.m104constructorimpl(th);
                        } catch (Throwable th2) {
                            Result.Companion companion2 = Result.Companion;
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        Integer m104constructorimpl;
        JvmClassMappingKt.getKotlinClass(cls);
        try {
            Result.Companion companion = Result.Companion;
            m104constructorimpl = Result.m104constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            m104constructorimpl = Result.m104constructorimpl(ResultKt.createFailure(th));
        }
