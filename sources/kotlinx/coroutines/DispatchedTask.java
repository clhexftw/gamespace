    ...
    public final void run() {
        ...
        try {
            ...
            if (job != null && !job.isActive()) {
                ...
                continuation.resumeWith(Result.m104constructorimpl(ResultKt.createFailure(exceptionalResult$external__kotlinx_coroutines__linux_glibc_common__kotlinx_coroutines_host)));
            } else {
                Result.Companion companion3 = Result.Companion;
                continuation.resumeWith(Result.m104constructorimpl(getSuccessfulResult$external__kotlinx_coroutines__linux_glibc_common__kotlinx_coroutines_host(takeState$external__kotlinx_coroutines__linux_glibc_common__kotlinx_coroutines_host)));
            }
            ...
            try {
                ...
                m104constructorimpl2 = Result.m104constructorimpl(unit);
            } catch (Throwable th) {
                Result.Companion companion5 = Result.Companion;
                m104constructorimpl2 = Result.m104constructorimpl(ResultKt.createFailure(th));
            }
            handleFatalException(null, Result.m106exceptionOrNullimpl(m104constructorimpl2));
        } catch (Throwable th2) {
            try {
                ...
                m104constructorimpl = Result.m104constructorimpl(ResultKt.createFailure(th3));
            }
            handleFatalException(th2, Result.m106exceptionOrNullimpl(m104constructorimpl));
        }
    }
}
