...
public final class CoroutineContextKt {
    ...
    public static final CoroutineContext newCoroutineContext(CoroutineContext coroutineContext, CoroutineContext addedContext) {
        Intrinsics.checkNotNullParameter(coroutineContext, "<this>");
        Intrinsics.checkNotNullParameter(addedContext, "addedContext");
        return !hasCopyableElements(addedContext) ? coroutineContext.plus(addedContext) : foldCopies(coroutineContext, addedContext, false);
    }
